...
log ""
log_table "BASE_URL" "$(color_value "$(format_value BASE_URL "$BASE_URL")" "\033[0;37m")"
log_table "LOG_LEVEL" "$(color_value "$(format_value LOG_LEVEL "$LOG_LEVEL")" "\033[0;37m")"
log ""
log_table "PKG_WATCHER_ENABLED" "$(color_value "$(format_value PKG_WATCHER_ENABLED "$PKG_WATCHER_ENABLED")" "\033[0;37m")"
log ""
