...
# from hb_store_m1.utils import scan_pkgs
#
#
...
#         log(
#             "info",
#             f"Scanning {len(pkg_list)} PKG(s) for changes...",
...
#             icon_path = (
#                 self.pkg_utils.extract_pkg_icon(pkg, content_id, dry_run=True)
#                 if content_id
#                 else None
#             )
#             icon_invalid = False
...
#
#             sorter_result, target_dir = self.sorter.dry_run(
#                 pkg, sfo_data.get("app_type", "")
#             )
#             planned_pkg_path = str(
#                 (target_dir / planned_name)
#                 if target_dir
#                 else (pkg.parent / planned_name)
#             )
#
...
#             ) or (
#                 planned_pkg_path in planned_paths
#                 and planned_pkg_path != current_pkg_path
#             )
#
#             reason = None
...
#             elif (
#                 formatter_result == AutoFormatter.PlanResult.CONFLICT
#                 or sorter_result == AutoSorter.PlanResult.CONFLICT
#             ):
#                 planned_pkg_action = PlanOutput.REJECT
#                 reason = (
#                     "formatter_conflict"
#                     if formatter_result == AutoFormatter.PlanResult.CONFLICT
#                     else "sorter_conflict"
#                 )
...
#             if planned_pkg_action != PlanOutput.REJECT and (
#                 missing_icon or icon_invalid
#             ):
#                 planned_pkg_action = PlanOutput.REJECT
...
#
#         planned_errors = sum(
#             1 for item in results if item["pkg"]["action"] == PlanOutput.REJECT
#         )
#         planned_icons = sum(
#             1
#             for item in results
